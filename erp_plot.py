...
class erp_plot:
    ...
    def plotRawEEG(self, event_code1=769, event_code2=770, filename="", bad_ch=[]):
        tmin, tmax = -1., 4.
    ...
    def plotPSD(self, event_code1=769, event_code2=770, filename="", bad_ch=["EMG"], cls="class1"):
        tmin, tmax = -1., 4.
        event_id = dict(class1=event_code1, class2=event_code2)
        ...
        epochs[cls].plot_psd(fmin=2., fmax=40.)
